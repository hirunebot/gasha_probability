                ...
                {calculationMode === "stoneBase" && (
                    <div className="bg-sky-50 border border-sky-200 rounded-lg p-4">
                        <div className="flex items-center justify-between">
                            ...
                            <div className="text-sky-700 text-4xl font-medium">
                                {pulls}
                    ...
                    <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 space-y-3">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                            <div className="flex items-center justify-between">
                                ...
                                <div className="text-blue-700 text-3xl font-medium">
                                    {pityItems}
                            ...
                            <div className="flex items-center justify-between">
                                ...
                                <div className="text-green-700 text-3xl font-medium">
                                    {Math.min(desiredAmount, hitsFromPity)}
                                    <span className="text-lg ml-1">個</span>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="text-center p-3 bg-white rounded-lg border border-sky-100">
                            <div className="text-slate-600 text-sm mb-2">
                                {desiredAmount}個以上出る確率
                            </div>
                            <div className="text-sky-700 text-5xl font-semibold">
                                {probAtLeastN.toFixed(2)}
